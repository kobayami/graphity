...
/**
 * JMH state for JGraphT benchmarks restricted to acyclic graphs
 * (mirrors {@link com.kobayami.graphity.benchmarks.graphity.DagFixture}).
 */
@State(Scope.Benchmark)
public class JGraphTDagFixture {
